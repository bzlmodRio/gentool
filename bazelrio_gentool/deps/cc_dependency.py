...
class CcDependency(MultiResourceDependency):
    ...
    CONDITIONS_LOOKUP = {
        ...
        "windowsarm64staticdebug": "@rules_bzlmodrio_toolchains//conditions:windows_arm64_debug",
        "linuxx86-64": "@rules_bzlmodrio_toolchains//conditions:linux_x86_64",
        ...
        "osxuniversalstaticdebug": "@rules_bzlmodrio_toolchains//conditions:osx_debug",
        # Cross Compilers
