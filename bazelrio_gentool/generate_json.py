...
def generate_json(central_registery_location, group, module_json_template, module_template):
    ...
    print(module_bazel_file)

    render_template(module_template, module_bazel_file, group=group, module_bazel_file=module_bazel_file, hash=hash, mandetory_dependencies=mandetory_dependencies)
