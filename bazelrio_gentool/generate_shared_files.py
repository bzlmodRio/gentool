...
def write_shared_root_files(module_directory, group):
    ...
    render_templates(template_files, module_directory, os.path.join(TEMPLATE_BASE_DIR, "shared"), group=group)
...
def write_shared_test_files(module_directory, group):
    ...
    render_templates(template_files, os.path.join(module_directory, "tests"), os.path.join(TEMPLATE_BASE_DIR, "shared"), group=group)
